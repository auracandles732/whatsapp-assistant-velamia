...
- Migraciones de la plataforma: `007` a `019`.
- Cada respuesta de la IA queda registrada en `ai_usage` (tokens por empresa) y una revisión diaria
  avisa por WhatsApp a `PLATFORM_ALERT_PHONE` cuando una empresa deja de poder atender.
